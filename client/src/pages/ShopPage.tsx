...
import { IceCreamIntroModal, isIceCreamCategory } from '../components/common/IceCreamIntroModal';
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-8 space-y-8">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 bg-slate-900/60 border border-slate-800 p-6 rounded-3xl">
        <div>
          <h1 className="text-2xl font-extrabold text-white">Catalog & Products</h1>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
        ...
        <div className="lg:col-span-3 space-y-8">
          <ProductGrid
            ...
            emptyMessage={
              selectedCategory
                ? `no products available from this catogery`
                : searchQuery
